...
$(document).ready(function() {
   ...
   // ZY.DataManager.zy_get_posts($("#zy_landscape_contain"),240,3,ZY.Config.lastLandscapeDate,true);
    ...
    $("#zy_landscape_next").click(function(){
        //调用函数
        ZY.DataManager.show_next_animate($("#zy_landscape_contain"),ZY.Config.articleWidths.sectionOneWidth,
            ZY.Config.categoryIds.sectionOneId,ZY.DataManager.lastLandscapeDate);
    ...
    $("#zy_landscape_prev").click(function(){
        //调用函数
        ZY.DataManager.show_prev_animate($("#zy_landscape_contain"),ZY.Config.articleWidths.sectionOneWidth,
            ZY.Config.categoryIds.sectionOneId);
    ...
    $("#zy_people_next").click(function(){
        //调用函数
        ZY.DataManager.show_next_animate($("#zy_people_contain"),ZY.Config.articleWidths.sectionTwoWidth,
            ZY.Config.categoryIds.sectionTwoId,ZY.DataManager.lastPeopleDate);
    ...
    $("#zy_people_prev").click(function(){
        //调用函数
        ZY.DataManager.show_prev_animate($("#zy_people_contain"),ZY.Config.articleWidths.sectionTwoWidth,
            ZY.Config.categoryIds.sectionTwoId);
    ...
    $("#zy_artifact_next").click(function(){
        //调用函数
        ZY.DataManager.show_next_animate($("#zy_artifact_contain"),ZY.Config.articleWidths.sectionThreeWidth,
            ZY.Config.categoryIds.sectionThreeId,ZY.DataManager.lastArtifactDate);

    });
    //物语向左点击
    $("#zy_artifact_prev").click(function(){
        //调用函数
        ZY.DataManager.show_prev_animate($("#zy_artifact_contain"),ZY.Config.articleWidths.sectionThreeWidth,
            ZY.Config.categoryIds.sectionThreeId);
    ...
    $("#zy_community_next").click(function(){
        //调用函数
        ZY.DataManager.show_next_animate($("#zy_community_contain"),ZY.Config.articleWidths.sectionFourWidth,
            ZY.Config.categoryIds.sectionFourId,ZY.DataManager.lastCommunityDate);
    ...
    $("#zy_community_prev").click(function(){
        //调用函数
        ZY.DataManager.show_prev_animate($("#zy_community_contain"),ZY.Config.articleWidths.sectionFourWidth,
            ZY.Config.categoryIds.sectionFourId);
    });
    ...
    $(window).resize(function(){
       ...
       resizeTimer=setTimeout(function(){
           ZY.UIManager.doResizeOfCategory($("#zy_people_contain"),ZY.Config.articleWidths.sectionTwoWidth,
               ZY.DataManager.peopleLoaded);
           ZY.UIManager.doResizeOfCategory($("#zy_landscape_contain"),ZY.Config.articleWidths.sectionOneWidth,
               ZY.DataManager.landscapeLoaded);
           ZY.UIManager.doResizeOfCategory($("#zy_community_contain"),ZY.Config.articleWidths.sectionFourWidth,
               ZY.DataManager.communityLoaded);
           ZY.UIManager.doResizeOfCategory($("#zy_artifact_contain"),ZY.Config.articleWidths.sectionThreeWidth,
