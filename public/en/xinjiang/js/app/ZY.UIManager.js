		...
		scrollingHandler:function(){
			...
			if(sy>landScapeY-winH && sy<=landScapeY+720){
				...
				if(!ZY.DataManager.landscapeLoaded){
                    ...
                    //获取第1个分类(风景）文章，等宽340
                    ZY.DataManager.zy_get_posts($("#zy_landscape_contain"),ZY.Config.articleWidths.sectionOneWidth,
                        ZY.Config.categoryIds.sectionOneId,ZY.DataManager.lastLandscapeDate,true);
			...
			if(sy>peopleY-winH && sy<=peopleY+720){
				...
				if(!ZY.DataManager.peopleLoaded){
                    ...
                    ZY.DataManager.zy_get_posts($("#zy_people_contain"),ZY.Config.articleWidths.sectionTwoWidth,
                        ZY.Config.categoryIds.sectionTwoId,ZY.DataManager.lastPeopleDate,true);
			...
			if(sy>artifactY-winH && sy<=artifactY+720){
				...
				if(!ZY.DataManager.artifactLoaded){
                    ...
                    //获取第3个分类(物语）文章，等宽400
                    ZY.DataManager.zy_get_posts($("#zy_artifact_contain"),ZY.Config.articleWidths.sectionThreeWidth,
                        ZY.Config.categoryIds.sectionThreeId,ZY.DataManager.lastArtifactDate,true);
			...
			if(sy>communityY-winH && sy<=communityY+720){
				...
				if(!ZY.DataManager.communityLoaded){
                    ...
                    //获取第4个分类(社区）文章，等宽400
                    ZY.DataManager.zy_get_posts($("#zy_community_contain"),ZY.Config.articleWidths.sectionFourWidth,
                        ZY.Config.categoryIds.sectionFourId,ZY.DataManager.lastCommunityDate,true);
