...
ZY.music={
    ...
    musicEdgePlay:function(){
        AdobeEdge.getComposition("EDGE-4537676").getStage().getSymbol("music_ant").play("start");
        AdobeEdge.getComposition("EDGE-4537676").getStage().$("music_horizon2").fadeOut(0.5);
        AdobeEdge.getComposition("EDGE-4537676").getStage().$("music_horizon1").fadeOut(0.5);
    },
    musicEdgeStop:function(){
        AdobeEdge.getComposition("EDGE-4537676").getStage().getSymbol("music_ant").playReverse("end");
        AdobeEdge.getComposition("EDGE-4537676").getStage().$("music_horizon2").fadeIn(0.5);
        AdobeEdge.getComposition("EDGE-4537676").getStage().$("music_horizon1").fadeIn(0.5);
    },
